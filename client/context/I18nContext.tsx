...
const dict: Record<Lang, Record<string, string>> = {
  ...
  hi: {
    ...
    available_for_duty: "ड्यूटी के लिए उपलब्ध",
    on_duty: "ड्यूटी पर",
    off_duty: "ड्यूटी से बाहर",
    toggle_to_set_availability: "उपलब्धता सेट करने के लिए टॉगल करें",
    your_route: "आपका रूट",
    from: "से",
    to: "तक",
    set_route: "रूट सेट करें",
    route: "रूट",
    current_location: "वर्तमान लोकेशन",
    location_unavailable: "लोकेशन उपलब्ध नहीं",
    refresh_location: "लोकेशन रिफ्रेश करें",
    status_updates: "स्टेटस अपडेट्स",
    add_update: "अपडेट जोड़ें",
    add_update_placeholder: "यात्रियों के ल��ए अपडेट लिखें (जैसे, \"5 मिनट में प्रस्थान\")",
